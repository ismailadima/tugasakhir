		...
		<h3>Tambah Pegawai</h3>
		    <div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="POST" action="<?php echo base_url('pegawai/tambah_pegawai');?>">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="tanggal_lahir" id="tanggal">
                              </div>
                          </div>
                          <div class="form-group">
